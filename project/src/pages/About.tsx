    ...
    <div className="bg-white overflow-hidden">
      ...
      <section className="relative py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-orange-50 via-white to-white overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute -left-24 -top-24 w-72 h-72 bg-orange-100 rounded-full blur-3xl opacity-50"></div>
          <div className="absolute right-10 top-10 w-64 h-64 bg-orange-200 rounded-full blur-3xl opacity-40"></div>
          <div className="absolute bottom-[-80px] left-1/3 w-80 h-80 bg-orange-100 rounded-full blur-3xl opacity-40"></div>
        </div>

        <div className="max-w-6xl mx-auto relative z-10 text-center space-y-6">
          <div className="inline-flex items-center gap-3 bg-white/80 border border-orange-100 text-orange-700 rounded-full px-5 py-2 shadow-sm">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 leading-tight">
            About <span className="bg-gradient-to-r from-orange-500 to-pink-500 bg-clip-text text-transparent">Saga Infographics</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <button
              ...
              className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-8 py-4 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all transform hover:scale-105 flex items-center gap-2"
            >
              Talk with us
              <ArrowRight className="w-5 h-5" />
            </button>
            <div className="flex items-center gap-3 text-gray-600 bg-white/70 border border-orange-100 rounded-full px-5 py-3 shadow-sm">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-lg text-gray-600 leading-relaxed bg-white border border-orange-100 rounded-2xl p-6 shadow-sm">
              <p>
          ...
          <div className="relative">
            <div className="absolute -inset-6 bg-gradient-to-br from-orange-200/50 to-orange-100/40 blur-3xl rounded-3xl"></div>
            <div className="relative grid grid-cols-2 gap-4 bg-white border border-orange-100 rounded-3xl p-4 shadow-xl">
              {[
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white via-orange-50/40 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 space-y-3">
            <div className="inline-flex items-center gap-2 bg-white/70 border border-orange-100 text-orange-700 px-4 py-2 rounded-full shadow-sm text-sm font-semibold">
              What guides us
            </div>
            <h3 className="text-4xl font-bold text-gray-900">Mission, Vision, Values</h3>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[{ title: 'Mission', icon: Target, copy: 'Empower brands with digital experiences that convert, scale, and delight.' }, { title: 'Vision', icon: Eye, copy: 'Set the standard for premium digital craft that marries design with performance.' }, { title: 'Values', icon: Heart, copy: 'Lead with empathy, ship with excellence, and stay curious together.' }].map((item, idx) => {
              ...
              return (
                <div key={idx} className="relative overflow-hidden rounded-2xl border border-orange-100 bg-white shadow-sm hover:shadow-lg transition-all">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 space-y-3">
            <div className="inline-flex items-center gap-2 bg-orange-100 text-orange-700 px-4 py-2 rounded-full text-sm font-semibold">Why partner with us</div>
            <h3 className="text-4xl font-bold text-gray-900">A team built for outcomes</h3>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              const Icon = item.icon;
              return (
                <div key={idx} className="relative rounded-2xl border border-orange-100 bg-white shadow-sm hover:shadow-xl transition-all overflow-hidden">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white via-orange-50/40 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 space-y-3">
            <div className="inline-flex items-center gap-2 bg-white/80 border border-orange-100 text-orange-700 px-4 py-2 rounded-full text-sm font-semibold shadow-sm">Track record</div>
            <h3 className="text-4xl font-bold text-gray-900">Numbers that back us up</h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={idx} className="relative rounded-2xl bg-white border border-orange-100 p-8 text-center shadow-sm hover:shadow-md transition-all">
                <div className="absolute inset-0 bg-gradient-to-br from-orange-500/5 to-transparent"></div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto relative overflow-hidden rounded-3xl border border-orange-100 bg-gradient-to-r from-orange-50 via-white to-white shadow-xl">
          ...
          <div className="relative px-8 py-14 text-center space-y-4">
            ...
            <h3 className="text-4xl font-bold text-gray-900">Ready to work together?</h3>
