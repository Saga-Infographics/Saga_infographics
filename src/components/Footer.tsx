...
const footerLinks = {
  Services: [
    ...
    { label: "Meta & Google Ads", to: "/services" },
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-white/40 text-sm leading-relaxed max-w-xs">
              ...
              marketing to development, we drive your success.
            </p>
            <div className="flex gap-3 mt-4">
              <span
                className="w-8 h-8 rounded-lg glass flex items-center justify-center text-white/40 hover:text-white hover:bg-white/10 cursor-pointer transition-all"
                aria-label="X"
              >
                <svg
      ...
      <div className="border-t border-glass-border">
        <div className="section-padding py-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-white/30 text-xs">
            &copy; 2025 Saga. All rights reserved.
          </p>
